        ...
        <div className="p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                {popularClasses.slice(0, 3).map((cls, index) => (
                    <div
                        key={cls._id}
                        className="relative bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl"
                    >
                        {/* Top gradient */}
                        <div
                        ...
                        >
                            {/* Circular image */}
                            <div className="absolute -bottom-14 w-28 h-28 sm:w-32 sm:h-32 rounded-full bg-white shadow-md flex justify-center items-center overflow-hidden border-4 border-white">
                                <img
                                    src={cls.image}
                                    alt={cls.title}
                        ...
                        <div className="pt-16 pb-4 px-4 text-center">
                            ...
                            <p
                                className="text-sm text-gray-500 mt-2 mb-4 line-clamp-2"
                            ...
                            onClick={()=>{
                                ...
                                className={`w-full py-2 rounded-full text-white bg-gradient-to-r ${gradientColors[index]} bg-[length:200%_200%] hover:bg-[position:100%_0] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-${gradientColors[
                                    index
                                ]
                                    .split(" ")[1]
                                    .replace("to-", "")} transition-all duration-500 ease-out`}
                            >
                                Enroll
                            </button>
                        </div>
