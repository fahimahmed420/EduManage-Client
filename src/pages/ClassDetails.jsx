...
const ClassDetails = () => {
    ...
    return (
        <div className="max-w-5xl mx-auto px-6 py-10 animate-fade-in">
            {/* SEO */}
            <Helmet>
                <title>{classData?.title ? `${classData.title} | EduManage` : "Class Details | EduManage"}</title>
                <meta name="description" content={classData?.description?.slice(0, 150) || "View course details and enroll today."} />
            </Helmet>
